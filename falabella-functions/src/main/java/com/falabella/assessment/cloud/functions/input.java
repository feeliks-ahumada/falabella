...
public class input extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
    private static final long serialVersionUID = -407792365341694755L;


    public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"input\",\"fields\":[{\"name\":\"body\",\"type\":\"string\"}]}");
    public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

    private static final SpecificData MODEL$ = new SpecificData();

    private static final BinaryMessageEncoder<input> ENCODER =
            new BinaryMessageEncoder<input>(MODEL$, SCHEMA$);

    private static final BinaryMessageDecoder<input> DECODER =
            new BinaryMessageDecoder<input>(MODEL$, SCHEMA$);
    ...
    public static BinaryMessageDecoder<input> createDecoder(SchemaStore resolver) {
        return new BinaryMessageDecoder<input>(MODEL$, SCHEMA$, resolver);
    }
     ...
     */
    public input(java.lang.CharSequence body) {
        this.body = body;
    }
    ...
    public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<input>
         ...
         * @return This builder.
         */
        public input.Builder setBody(java.lang.CharSequence value) {
         ...
         * @return This builder.
         */
        public input.Builder clearBody() {
            body = null;
